<template>
  <div class="page">
    <div class="header">
      <div class="title">2019年度销售总览</div>
    ...
    <div class="row">
      <div class="col-md-4">
        ...
        <div class="col-md-12">
          <table
            class="table border-table darkblue"
            style="width: 100%"
            cellpadding="0"
            cellspacing="0"
          >
            <tr>
              ...
              <td class="th">区域</td>
              <td class="th td_right">年销售量</td>
              <td class="th td_right">月销售量</td>
              <!--<th>二级部门</th>-->
            </tr>
        ...
        tooltip: {
          ...
          formatter: function (a, b, c) {
            return `${a[0].axisValue}<br/>${
              a[0].seriesName
            }  ${formatLargeNumber(a[0].value)}万元`;
          },
        },
        legend: {
          left: "right",
